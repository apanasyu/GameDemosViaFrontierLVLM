...
| **Donkey Kong** | A single-screen platformer where the player must climb a structure of girders and ladders to rescue a princess while avoiding barrels thrown by an ape, "Kong," at the top of the screen. | ... | [Link](./Donkey Kong/) | [Watch](https://youtube.com/link) | ... |
...
| **Memory Game** | A tile-based memory game where the player flips over pairs of face-down cards on a grid. The objective is to find all matching pairs. A non-matching pair is briefly shown before being flipped back. | ... | [Link](./Memory Game/) | [Watch](https://youtube.com/link) | ... |
